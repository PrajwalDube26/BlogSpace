...
const BlogState = (props) => {
  ...
  const Signup = async (name, email, password, photo) => {
    ...
    const response = await fetch(`http://localhost:5000/api/auth2/SingUp`, {
      method: "POST",
      body: formData,
      credentials: "include"
    });
  ...
  const login=async(email,password)=>{
    //api call
    const response = await fetch(`http://localhost:5000/api/auth2/login`, {
      method: "POST",
      headers: {
  ...
  const logout=async()=>{
    //api call
    const response = await fetch(`http://localhost:5000/api/auth2/logout`, {
      method: "POST",
      credentials: "include"
  ...
  const featchuser = async() =>{
    ...
    //api call
    const response = await fetch(`http://localhost:5000/api/auth2/featchuser`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const featchblogs = async() =>{
    ...
    //api call
    const response = await fetch(`http://localhost:5000/api/blog_route/featchownblog`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const featchallblogs = async() =>{
    ...
    //api call
    const response = await fetch(`http://localhost:5000/api/blog_route/featchAllblog`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const deleteblog=async( id )=>{
    ...
    const response = await fetch(`http://localhost:5000/api/blog_route/delete_blog/${id}`, {
      method: "DELETE",
      credentials: "include"
  ...
  const editblog=async( id ,title,content)=>{
    ...
    const response = await fetch(`http://localhost:5000/api/blog_route/update_blog/${id}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
